...
<tr><td align=center>T est la periode ou demie vie. C'est le temps nécessaire pour que la moitié des noyaux de l'isotope initialement présents se désintègrent naturellement</br>T = ln(2) / λ</td><td align=center>T est considérée comme une demie vie dans le cas d'une decroissance (q < 1), et comme un temps de doublement dans le cas d'une croissance (q > 1)</br>T = ln(2) / r</td></tr> 
</table></div>
